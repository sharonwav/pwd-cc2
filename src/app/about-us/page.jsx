            ...
            <div className='flex items-center justify-center w-[100%] py-[5rem]'>
                <div className='flex flex-col items-start justify-start gap-5'>
                    <p className='text-xl text-gray-500'>
                        Launched in 2012, Typeform drivea more than 500 million digital interactions <br/>
                        per year and integrates with hundreds of other business-critical tools like <br/>
                        HubSpot, Calendly, and Slack, to name a few.
                    </p>
                    <p className='text-xl text-gray-500'>
                        At Typeform, we help brands treat people like with thoughtfully-designed<br/>
                        tools that turn digital interactions into lasting personal connections.
                    </p>
                    <p className='text-xl text-gray-500'>
                        Because what do customers, prospects, users, leads, recruits, and employees (the<br/>
                        list goes on) all have in common? They're all people. And people are essential to<br/>
                        growth.
                    </p>
                    <p className='text-xl text-gray-500'>
                        With our no-code forms, quizzes, surveys, and asynchronous videos, brands can<br/>
                        engage their audience and grow their business with ease.
                    </p>
                </div>
            </div>
        </div>
      </section>
      <section className='bg-[#eaeae9] pt-[6rem]'>
        <div className='m-auto max-w-screen-xl min-h-min flex flex-col items-center justify-center py-[2rem]'>
            <p className='h2 py-[2rem]'>Why work at Typeform?</p>
            <p className='mt-1 text-xl'>Good question. Here are a few reasons...</p>
            <div className='w-[100%] grid grid-cols-3 gap-8 mt-[12rem] py-[5rem]'>
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-thin text-gray-600'>
                        We start from empathy, always with the<br/>
                        customer in mind. We bring our best<br/>
                        everyday, owning our mistakes, remaining<br/>
                        accountable, delivering results fast and<br/>
                        learning faster. We win (and lose) together.<br/>
                        And we encourage each other along the<br/>
                        way, adding a human touch.
                    </p>
                </div>
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-thin text-gray-600'>
                        We're now a remote-first company. You'll<br/>
                        be made to feel at home from the first<br/>
                        moment, thanks to out thoughtfully<br/>
                        designed remote onboarding. We want to<br/>
                        create the best setup for success. Some<br/>
                        examples are: top-notch gear, home<br/>
                        office setup budget, monthly support<br/>
                        allowance, access to a coaching platform<br/>
                        called Bravely, and many other perks.
                    </p>
                </div>
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-thin text-gray-600'>
                        As we scale, we are upgrading our ways of<br/>
                        working to adapt to a more asynchronous<br/>
                        way of working, which combined with all<br/>
                        the flexibility you need to perform like a<br/>
                        grown-up who does not need to be<br/>
                        chased, eases night-owls and early birds<br/>
                        from all over the world to go the extra<br/>
                        mile and deliver their best work ever.
                    </p>
                </div>
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-thin text-gray-600'>
                        Typeform is a diverse and inclusive group<br/>
                        of professionals from all over the world on<br/>
                        a mission to Inspire brands to have<br/>
                        meaningful conversations, at scale. With<br/>
                        so many different perspectives, we get to<br/>
                        learn from each other, improving<br/>
                        ourselves every day.
                    </p>
                </div>
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-thin text-gray-600'>
                        At Typeform, you'll learn something new<br/>
                        every day. Growing fast means more<br/>
                        opportunities for everyone, and we<br/>
                        encourage you to drive your own journey<br/>
                        with us and keep developing yourself<br/>
                        professionally with your own L&D budget.
                    </p>
                </div>
            </div>
        </div>
