...
const HomePage = () => {
  return (
    <main className="home-main flex flex-col">
      ...
      {/* SECTION A */}
        <section className="home-section-a flex">
          <div className="home-section-a-left">
            <video className="video-container" autoPlay muted loop playsInline>
              <source src='https://www.typeform.com/static/homepage-refresh/hero/hero.mp4' type="video/mp4" />
            </video>
          </div>
          <div className="home-section-a-right flex flex-col items-start justify-center gap-10">
            <p className="h1">
              Get to know your<br/>
              customers with<br/>
              forms worth filling<br/>
              out
            </p>
            <p className="h6">
              Collect all the data you need to <span>understand customers</span> with forms designed to be<br/>
              refreshingly different.
            </p>
            <Link href='' className="btn-black">Get started-it's free</Link>
          </div>
        </section>
        ...
        <section className="home-section-b">
          ...
          <div className="py-[5rem] flex flex-col gap-[5rem]">
            <p className="h2 text-center">
              Typeform helps you understand<br/>
              customers
            </p>
            {/* INNER SECTION */}
            <section className="home-section-b-inner flex items-center">
              <div className="home-section-b-inner-left flex flex-col items-start justify-center gap-5">
                <p>FORMS, SURVEYS, AND QUIZZES</p>
                <p className="h3">
                  Get up to 3.5x more<br/>
                  data about them
                </p>
                <p className="h6">
                  When your forms break the norm, more people fill<br/>
                  them out. Think branded designs, video content, and<br/>
                  relevant follow-up questions.
                </p>
                <Link href='' className="btn-black btn-black-custom">Sign up</Link>
              </div>
              <div className="home-section-b-inner-right flex items-center">
                <video className="video-container" autoPlay muted loop playsInline>
                  <source src='https://www.typeform.com/static/homepage-refresh/media-text-module/section-1.webm' type="video/webm" />
                </video>
              </div>
            </section>
            <section className="home-section-b-inner flex items-center">
              <div className="home-section-b-inner-left flex items-center">
                <video className="video-container" autoPlay muted loop playsInline>
                  <source src='https://www.typeform.com/static/homepage-refresh/media-text-module/section-2.webm' type="video/webm" />
                </video>
              </div>
              <div className="home-section-b-inner-right flex flex-col items-start justify-center gap-5">
                <p>CUSTOMER INTELLIGENCE</p>
                <p className="h3">
                  Use that data to guide<br/>
                  your next move
                </p>
                <p className="h6">
                  What led customers to you. Their opinions. How they<br/>
                  decide what to buy. Data can tell you a lot and our AI<br/>
                  analysis can help you make sense of it all.
                </p>
                <Link href='' className="btn-black btn-black-custom">Sign up</Link>
              </div>
            </section>
            <section className="home-section-b-full flex items-center">
              <div className="home-section-b-container-peach flex items-center justify-center px-[3rem]">
                <div className="flex flex-col items-start justify-center gap-3">
                  <p className="h1a">
                    "We need to know that<br/>
                    we're building the right<br/>
            ...
            <section className="home-section-b-benefit flex flex-col gap-[5rem]">
              <p className="h1a text-center">
                With a superior form of<br />
                data collection
              </p>
              <div className="flex items-center justify-center gap-7">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="h6a">
                      Your forms will look anything but ordinary. Customize the<br/>
                      entire design, embed it in all the right places, and strike a<br/>
                      chord with engaging video content.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="h6a">
                      More data is just a follow-up question away. Encourage<br/>
                      customers to elaborate by asking questions based on<br/>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="h6a">
                      Some data is harder to come by. Collect readily-available<br/>
                      data without having to ask so your customers can focus<br/>
                      on sharing everything else.
                    </p>
                  </div>
                </div>
              </div>
              <div className="home-section-b-link flex items-center justify-center gap-5">
                <Link href="" className="btn-black btn-black-thin-two">Compare plans</Link>
                <Link href="" className="text-black underline">Browse all templates</Link>
              </div>
              <div className="home-section-b-icons flex items-center justify-center gap-[9rem]">
                <div className="flex flex-col">
                  <p>
                    Works with<br/>
                    all yout tools
                  </p>
                  <Link href="" className="text-black underline">Browse 300+ integrations</Link>
                </div>
              ...
              <div className="home-section-b-why-typeform flex flex-col gap-[4rem]">
                <div className="flex flex-col items-center justify-center gap-3">
                  <p className="h1a">Why Typeform?</p>
                  <p className="h6b">Because after switching to us...</p>
                </div>
                <div className="flex items-center justify-center gap-[10rem]">
                  <div className="flex flex-col items-center justify-center gap-5">
                    <p className="h1a">96%</p>
                    <p className="h6b text-center">
                      of customers say they<br/>
                      have a better brand<br/>
                      experience
                    </p>
                  </div>
                  <div className="flex flex-col items-center justify-center gap-5">
                    <p className="h1a">95%</p>
                    <p className="h6b text-center">
                      of customers say they<br/>
                      gather more data, more<br/>
                      easily
                    </p>
                  </div>
                  <div className="flex flex-col items-center justify-center gap-5">
                    <p className="h1a">87%</p>
                    <p className="h6b text-center">
                      of customers say they<br/>
                      reveal deeper insights<br/>
                      from data
                    </p>
                  </div>
                </div>
      ...
      <section className="m-auto m-w-screen-sm min-h-min py-[5rem] flex flex-col">
        <p className="text-white text-center h1a">
          Start getting to know your<br/>
          customers
        </p>
        <div className='flex flex-col items-center justify-center py-[5rem]'>
          <p className="text-white h6">Our Free Plan lets you:</p>
          <div className="flex flex-col items-center justify-center">
            <p className="text-white h6b">Create unlimited forms</p>
            <p className="text-white h6b">Access 3,000+ templates</p>
            <p className="text-white h6b">Start getting responses</p>
          </div>
        </div>
        <div className="flex items-center justify-center gap-[2rem] mt-4">
          <Link href="" className="btn-white-thin">Sign up</Link>
          <Link href="" className="btn-white-link underline">Compare plans</Link>
        </div>
