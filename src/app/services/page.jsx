...
const ServicesPage = () => {
  return (
    <main className='services'>
      <section className='bg-white pt-[6rem] pb-[3rem]'>
        <div className='m-auto max-w-screen-xl min-h-min flex items-start justify-center gap-[7rem] py-[2rem]'>
            ...
            <div className='flex flex-col gap-[3rem]'>
                <p className='h1a'>
                    Calm: a success story of<br/>
                    mindful forms and empowered<br/>
                    decision-making
                </p>
                ...
                <div className='flex flex-col'>
                    <p className='text-[1.8rem]'>
                        ...
                        straightforward and easy to use, and the support<br/>
                        team gets us what we need. They're really<br/>
                        responsive."
                    </p>
                    <p className='text-sm'>Chase Clark, Senior UX Researcher at Calm</p>
                </div>
                <p className='text-xl'>
                    The great German poet Hermann Hesse once said, "Within you, there is a<br/>
                    stillness and sanctuary to which you can retreat at any time and be yourself."<br/>
                    Calm founders Alex Tew & Michael Acton Smith channeled this ideology<br/>
                    when they brought their sleep, meditation, and relaxation app to the world in 2012.<br/> 
                    Now, a decade and several awards later, Calm boasts over 4 million <br/>
                    subscribers and shows no signs of slowing down.
                </p>
                <p className='text-xl'>
                    Their ongoing success is partly due to the business model itself. The world tells <br/>
                    consumers to work harder and go faster. Calm, on the other hand, encourages <br/>
                    the opposite; slow down, calm your mind, and remove the external distractions <br/>
                    of everyday life.
                </p>
                <p className='text-xl'>
                    Another driver of Calm's success is their integration of customer feedback into<br/>
                    product innovation—something many claim to do, but few do well. To collect<br/>
                    (and action on) this feedback, Calm needed a partner who could elicit<br />
                    feedback in an inviting and engaging way.
                </p>
                <p className='h3'>
                ...
                <p className='text-xl'>
                    ...
                    internal initiative or KPI. This application of mindfulness demonstrates exactly<br/>
                    the "practice what you preach" value that many consumers want our of their<br />
                    brands.
                </p>
                <p className='h3'>
                ...
                <p className='text-xl'>
                    Calm is an innovator. They continuously improve the user experience by<br/>
                    focusing on engaging features that appeal to both new customers and long-<br/>
                    time users. Typeform helps Calm open a line of direct communication<br/>
                    between their team and their customers. Unvalidated innovation efforts<br/>
                    can be costly. This is why feedback from users directly informs Calm's innovation<br/>
                    efforts.
                </p>
                <p className='text-xl'>
                    Surveys are the most effective method Calm uses to gather user data. They<br/>
                    engage with a select set of users to gain their feedback on current app<br/>
                    experiences. This includes learning what works for users, and also what isn't<br/>
                    working or what might be missing. They also use the forms to tease out new<br/>
                    ideas to see which ideas resonate with people before investing engineering<br/>
                    dollars into it.
                </p>
                <p className='text-xl'>
                    "We need to know that we're building the right things for real problems and<br/>
                    just keeping a pulse on what has changed," reports Chase Clark, Senior UX<br/>
                    Researcher at Calm.
                </p>
                <p className='text-xl'>
                    Polling users is generally simple and straightforward; there are a variety of<br/>
                    companies who offer integrated APIs and products to easily enable online<br/>
                    surveys.
                </p>
                <p className='text-xl'>
                    "With the other service we were using, we quickly hit the cap, so we needed to<br/>
                    find another solution," continues Clark. "With Typeform, we realized that we<br/>
                    could get more surveys out and we wouldn't be limited in the same ways as we<br/>
                    were with other survey companies we'd worked with in the past. This gave us a<br/>
                    much broader spectrum of users we could survey to get more comprehensive<br/>
                    results."
                </p>
                <p className='text-xl'>
                    Calm originally turned to Typeform to solve the usage cap, but what secured<br/>
                    them as a partner was much more. "Typeform is great for us because the<br/>
                    product is straightforward and easy to use, and the support team gets us what<br/>
                    we need. They're really responsive," says Clark. "We also love the design. It's<br/>
                    just a better design, looks nicer, snappier, flows better—just seems a little bit<br/>
                    more modern, which is more appealing for our users."
                </p>
                <p className='text-xl'>
                    Calm can unlock the right data with the help of Typeform.<br/>
                    They can understand the size of different customer types, make sure they're supplying<br/>
                    the right number of solutions for each problem, innovate new solutions, and <br/>
                    more. With this data in-hand, Calm can make better, more informed decisions.
                </p>
                <p className='h3'>
                    What's next
                </p>
                <p className='text-xl'>
                    According to Clark, the next step for Calm's partnership with Typeform is to<br/>
                    start using the integrations. Instead of exporting and sharing data manually,<br/>
                    Typeform integrations, such as Google Sheets and Slack, make data sharing<br/>
                    seamless. By removing operational friction, Calm teams can instead focus on<br/>
                    improving processes and building better forms. After all, their goal is to help<br/>
                    people find their calm; the more data they have, the better they can cater the<br/>
                    app experience to people's needs.
                </p>
            </div>
        </div>
      </section>
